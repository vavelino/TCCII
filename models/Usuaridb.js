...
connection.query("CREATE TABLE IF NOT EXISTS usuarioSite (id INT UNSIGNED NOT NULL AUTO_INCREMENT,nome VARCHAR(255) unique NOT NULL,email VARCHAR(255) NOT NULL,senha VARCHAR(100) NOT NULL, eadmin bool, dt datetime NOT NULL, PRIMARY KEY (id))",
    function (err, result) {
        if (!err) {
